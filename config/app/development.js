...
module.exports = {
  ...
  KYC: {
    ...
    documentPassword: process.env.KYC_DOCUMENT_PASSWORD || 'SCqNvxALwBuKLu4myGebX6kuV'
  },
  cryptoPrice: {
    syncInterval: process.env.CRYPTO_PRICE_INTERVAL || 60, // seconds
    apiUrl: 'https://min-api.cryptocompare.com',
    web3URL: process.env.WEB3_URL || 'https://mainnet.infura.io/TSyakl4wJlsZT4Y1Vkzt'
  },
  etherscan: {
    apiUrl: 'https://api.etherscan.io/api',
    apiKey: '4TXJ86XCKIURDQBAF4PFRXR93PFVEIZ4SJ',
    intervalCheck:  process.env.ETHERSCAN_PRICE_INTERVAL || 500 * 60, //seconds
   ...
   */
  telegram: {
    botToken: process.env.TELEGRAM_TOKEN || '528200181:AAH4AzbOjOZrKJ2Nru1ibKYWS7U2mN7eXfk',
    botUrl: process.env.TELEGRAM_URL || 'https://t.me/isabbel_bot',
    pooling: process.env.TELEGRAM_POOLING || true,
    groupId: '@yoyoytelegra',
   ...
   */
  twitter: {
    consumer_key: process.env.TWITTER_CONSUMER_KEY || '0Zu1xdBPtzjlSmSBMcTNjL8zj',
    consumer_secret: process.env.TWITTER_CONSUMER_SECRET || 'i6bzxC3YT0RvSt1AR9rpEUr8jaNezAG1LygH3k61CqyKCRJb3L',
    bearer_token: process.env.TWITTER_BEARER_TOKEN
  },
  verifyEmailSecret: '6ZrLSQBs3aWqN5z6',
  driveURI: `https://${process.env.DOMAIN}/drive`,
